...
-- 半角入力に切り替え (Ctrl + Shift + J)
map('i', '<C-S-j>', '<cmd>im-select com.apple.keylayout.ABC<CR>', { noremap = true, silent = true })

-- 全角入力に切り替え (Ctrl + Shift + :)
map('i', '<C-S-:>', '<cmd>im-select com.apple.inputmethod.Kotoeri.RomajiTyping.Japanese<CR>', { noremap = true, silent = true })
